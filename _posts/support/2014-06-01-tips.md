...
---
**What’s the Omnibar?**
The Omnibar is the black bar next to your avatar at the top right of your stream. You can use it to post things on Ello. You can also use the Omnibar to mention others in your posts.

![The Ello Omnibar]({% asset_path omnibar.png %})

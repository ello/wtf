...
The [Ello iOS app](http://appstore.com/ello/ello) was released June 18, 2015.

An Android is app is in development, but no official release date is currently set. We will post one when we get closer to finishing it!

You can always use Ello on tablets and smartphones (including all Apple, Android, and Windows-based devices) through the web browser. Ello works great on mobile, and we suggest simply bookmarking Ello on the home screen of your mobile device.

...
Navigate to your [Settings]({{ site.webapp_url }}/settings) page. Click the invite icon and follow the instructions.
...
You can get to your [Settings]({{ site.webapp_url }}/settings) page from your profile page. Click on your avatar to get to your profile, and then click on the Settings icon.
...
Click the gear icon to go to your [Settings]({{ site.webapp_url }}/settings) page, then drag & drop new images. Alternatively, click the image icon to use your browser to select a file from your computer or mobile device.

## How do I log out?

You can log out by clicking the “Logout” link in the upper right hand corner of the [Settings]({{ site.webapp_url }}/settings) page.

## How can I permanently delete my Ello account?

Go to your [Settings]({{ site.webapp_url }}/settings) page by clicking on the gear icon, and click the “Delete Account” link. Once you delete your account neither you, nor we, can recover it. It’s over, baby. Also note that your username may become available for another user to use.

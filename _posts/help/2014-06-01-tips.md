...
Click the [search](/search) icon, type in the keyword that you're looking for, and hit go. Use [search words](/wtf/post/search-tips) to improve your search. 
...
On the [search](/search) page, type in the username or name that you're looking for, and hit go. Posts containing your search will automatically appear. Click "People" to find users. 

## How do I find other people that share my interests?

Find people and posts with content you're interested in just by typing whatever it is you're looking for into the [search](/search) bar. Groups and #tagging are coming. In the meantime, we're experimenting with community pages (repurposed user accounts) led by real humans. Check out the community directory [here](/wtf/post/communitydirectory).
...
You can get to your [Settings](/settings) page by clicking on the more icon and selectinv "Settings" from the dropdown list. 
...
On your [Settings](/settings) page, drag & drop images directly in the avatar and header areas. You can also click on the image icon inside the avatar or header area to use your browser to select a file from your computer or mobile device.

## How do I log out?

You can log out by clicking on the more icon in the upper right hand coner and selecting “Logout” from the dropdown list. 

You can also log out on the [settings](/settings) page. 

## How can I permanently delete my Ello account?

On your [Settings](/settings) page, click the “Delete Account” link. Once you delete your account neither you, nor we, can recover it. It’s over, baby. Also note that your username may become available for another user to use.

...
When you agree to let the Ello app access your contact list to find your friends, the email addresses are hashed before they are sent to the Ello servers. This essentially means they are encrypted in such a way that our severs can match them (so you can find your friends) but neither we nor anyone else can’t store or use the emails for anything else. Your contact list is protected!

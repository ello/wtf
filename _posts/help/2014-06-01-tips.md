...
## How do I search for or my friends?

On the [Search]({{ site.webapp_url }}/search) page, type in your friend's name or username, and hit go. Click "People" to find users.

You can also find your friends through the iOS mobile app if you have their emails in your contacts! Click "Find and invite your friends" and follow the instructions. Ello will expressly ask for your permission before looking through the emails in your contacts.

## How are e-mails protected when importing friends?

Email addresses are one-way hashed with a salt, and not permanently stored by Ello.

## What if I don't want people to find me?

Just set "Discoverable" to "No" on your [Settings](ello.co/setting) page and no one will be able to find you using the "Find your friends" feature on the iOS app!

## How do I invite my friends?

Click the invite icon in the upper right hand corner and follow the instructions. 

On the iOS app, click "Find and invite your friends" and follow the instructions. Ello will expressly ask for your permission before looking through the emails in your contacts.

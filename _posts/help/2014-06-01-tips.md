...
{% image omnibar.png alt="The Ello Omnibar" %}
...
{% image text-formatting.jpg alt="Ello text formatting tools" %}
...
{% image resizing.gif alt="Resize large images by clicking on them" %}

## Can I edit a post once I’ve put it up?

Yes. Click the edit icon under any post.

{% image edit-icon.jpg alt="Editing a post" %}
...
{% image comment-icon.jpg alt="Commenting on a post" %}
...
{% image repost-icon.jpg alt="Reposting a post" %}
...
{% image search-icon.jpg alt="Searching on Ello" %}
...
{% image following-button.png alt="Ello following controls" %}
...
{% image loves-icon.jpg alt="Ello loves icon" %}
...
{% image loves-profile.jpg alt="Ello user loves" %}
...
[Here](/wtf/resources/logos-wallpapers/).
...
If you already had an existing Ello account, posts, loves and shares from your Nabaroo account could not be migrated. You can manually post your previous Nabaroo posts into your Ello account and check out [ello.co/nabaroo](ello.co/nabaroo) to locate past Nabaroo connections.

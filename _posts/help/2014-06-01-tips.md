...
Click on the [Discover]({{ site.webapp_url }}/discover) icon. Select “Recommended”, “Related”, or “Random”. Select people based on the content that you find interesting.
...
Find people and posts with content you're interested in just by typing whatever it is you're looking for into the [Search]({{ site.webapp_url }}/search) bar. Groups are coming. In the meantime, we're experimenting with community pages led by other people on Ello. Check out the community directory [here](/wtf/resources/community-directory/).

Hashtags are live on Ello on the web. Use hashtags to organize your posts and find things that inspire you. Search works for hashtags too. For example, when you search "#art", posts with the hashtag "#art" will appear on top. 

(Hashtags will be working very soon on the Ello iOS app, too -- we're just waiting for the App store to approve the update.) 
...
![my-loves](https://d324imu86q1bqn.cloudfront.net/uploads/asset/attachment/3034181/ello-optimized-3d19fb86.jpg)

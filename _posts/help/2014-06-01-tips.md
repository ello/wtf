...
Click the [Search](https://ello.co/search) icon, type in the keyword that you're looking for, and hit go. Use [search words](/wtf/help/search/) to improve your search. 
...
On the [Search]({{ site.webapp_url }}/search) page, type in the username or name that you're looking for, and hit go. Posts containing your search will automatically appear. Click "People" to find users. 

...
![pride](http://i.imgur.com/e4hl44V.png) `{{ '&#58;pride&#58;' | markdownify | strip_html }}`<br>
![prosper](http://i.imgur.com/Aw3U7vR.png) `{{ '&#58;prosper&#58;' | markdownify | strip_html }}` (Emoji contest winner, by @ejg2)<br>
![hot_shit](http://i.imgur.com/VpbtnWN.png) `{{ '&#58;hot_shit&#58;' | markdownify | strip_html }}` (Emoji contest runner-up, by @b_worsfold)<br>
![llama](http://i.imgur.com/5CU84GG.png) `{{ '&#58;llama&#58;' | markdownify | strip_html }}` (Emoji contest runner-up, by @uforiathedark)<br>
![kim_jong_un](http://i.imgur.com/49sDIQV.png) `{{ '&#58;kim_jong_un&#58;' | markdownify | strip_html }}` (Emoji contest runner-up, by @zebmachine)<br>
![ello_smiley](http://i.imgur.com/nsUNqIU.png) `{{ '&#58;ello_smiley&#58;' | markdownify | strip_html }}` (Emoji contest runner-up, by @jessescitech)<br>
![doge](http://i.imgur.com/9dLzbPd.png) `{{ '&#58;doge&#58;' | markdownify | strip_html }}` (Emoji contest runner-up, by @businessinsider)<br>

...
![hot_shit](http://i.imgur.com/Ob3iuUi.png) `{{ '&#58;hot_shit&#58;' | markdownify | strip_html }}` (Emoji contest runner-up, by @b_worsfold)
![llama](http://i.imgur.com/5CU84GG.png) `{{ '&#58;llama&#58;' | markdownify | strip_html }}` (Emoji contest runner-up, by @uforiathedark)
![kim_jong_un](http://i.imgur.com/49sDIQV.png) `{{ '&#58;kim_jong_un&#58;' | markdownify | strip_html }}` (Emoji contest runner-up, by @zebmachine)
![ello_smiley](http://i.imgur.com/nsUNqIU.png) `{{ '&#58;ello_smiley&#58;' | markdownify | strip_html }}` (Emoji contest runner-up, by @jessescitech)
![doge](http://i.imgur.com/pFw5N1P.png) `{{ '&#58;doge&#58;' | markdownify | strip_html }}` (Emoji contest runner-up, by @businessinsider)
